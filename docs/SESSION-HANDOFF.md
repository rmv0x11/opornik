...
**В фоне (проверить!):** (1) `/tmp/opornik-gen3data.log` — gen-3 data 80k×216 политикой НОВОГО чемпиона (seed 2026, ~11 ч; роллаут-машинерия обобщена на Evaluator — `d24265e`); (2) `/tmp/opornik-duel2rec.log` — добор 2-ply дуэли 600 игр seed 31337 (суммарно будет 1200).
